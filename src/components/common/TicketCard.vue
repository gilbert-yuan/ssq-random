<template>
  <div class="ticket">
    ...
    <div class="ticket-actions">
      <button class="small-button copy-button" :class="{ copied }" type="button" @click="$emit('copy', ticket)">{{ copied ? '已复制' : '复制' }}</button>
...
<script setup>
import BallList from "@/components/common/BallList.vue";
